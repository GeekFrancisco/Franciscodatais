...
file_path = os.path.join(base_dir, 'Backlog_5.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_05_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 09/02 a 13/02', fontsize=16)
