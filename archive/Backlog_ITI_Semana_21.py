...
file_path = os.path.join(base_dir, 'Backlog_21.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_21_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 01/06 a 05/06', fontsize=16)
