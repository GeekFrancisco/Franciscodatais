...
file_path = os.path.join(base_dir, 'Backlog_29.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_29_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 27/07 a 31/07', fontsize=16)
