...
file_path = os.path.join(base_dir, 'Backlog_2.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_02_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 19/01 a 23/01', fontsize=16)
