...
file_path = os.path.join(base_dir, 'Backlog_24.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_24_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 22/06 a 26/06', fontsize=16)
