...
file_path = os.path.join(base_dir, 'Backlog_23.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_23_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 15/06 a 19/06', fontsize=16)
