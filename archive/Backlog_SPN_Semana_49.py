...
file_path = os.path.join(base_dir, 'Backlog_49.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_49_2025.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 08/12 a 12/12', fontsize=16)
