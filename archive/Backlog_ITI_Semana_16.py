...
file_path = os.path.join(base_dir, 'Backlog_16.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_16_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 27/04 a 30/04', fontsize=16)
