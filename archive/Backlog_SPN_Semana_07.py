...
file_path = os.path.join(base_dir, 'Backlog_7.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_07_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 23/02 a 27/02', fontsize=16)
