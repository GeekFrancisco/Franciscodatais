...
file_path = os.path.join(base_dir, 'Backlog_30.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_30_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 03/08 a 07/08', fontsize=16)
