...
file_path = os.path.join(base_dir, 'Backlog_11.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_11_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 23/03 a 27/03', fontsize=16)
