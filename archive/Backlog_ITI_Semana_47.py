...
file_path = os.path.join(base_dir, 'Backlog_47.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_47_2025.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 24/11 a 28/11', fontsize=16)
