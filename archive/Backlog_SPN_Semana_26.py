...
file_path = os.path.join(base_dir, 'Backlog_26.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_26_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 06/07 a 10/07', fontsize=16)
