...
file_path = os.path.join(base_dir, 'Backlog_1.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_01_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 12/01 a 16/01', fontsize=16)
