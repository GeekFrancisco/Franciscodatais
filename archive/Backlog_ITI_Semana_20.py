...
file_path = os.path.join(base_dir, 'Backlog_20.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_20_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 25/05 a 29/05', fontsize=16)
