...
file_path = os.path.join(base_dir, 'Backlog_33.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_33_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 24/08 a 28/08', fontsize=16)
