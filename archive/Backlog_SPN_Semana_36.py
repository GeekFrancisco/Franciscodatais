...
file_path = os.path.join(base_dir, 'Backlog_36.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_36_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 14/09 a 18/09', fontsize=16)
