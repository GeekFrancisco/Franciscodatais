...
file_path = os.path.join(base_dir, 'Backlog_15.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_15_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 20/04 a 24/04', fontsize=16)
