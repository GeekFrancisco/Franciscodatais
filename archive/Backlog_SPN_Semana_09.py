...
file_path = os.path.join(base_dir, 'Backlog_9.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_09_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 09/03 a 13/03', fontsize=16)
