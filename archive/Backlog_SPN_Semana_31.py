...
file_path = os.path.join(base_dir, 'Backlog_35.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_35_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 08/09 a 11/09', fontsize=16)
