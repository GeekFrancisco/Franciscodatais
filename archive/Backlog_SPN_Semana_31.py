...
file_path = os.path.join(base_dir, 'Backlog_31.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_31_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 10/08 a 14/08', fontsize=16)
