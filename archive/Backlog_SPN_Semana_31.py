...
file_path = os.path.join(base_dir, 'Backlog_34.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_34_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 31/08 a 04/09', fontsize=16)
