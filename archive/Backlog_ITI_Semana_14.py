...
file_path = os.path.join(base_dir, 'Backlog_14.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_14_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 13/04 a 17/04', fontsize=16)
