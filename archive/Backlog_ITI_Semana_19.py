...
file_path = os.path.join(base_dir, 'Backlog_19.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_19_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 18/05 a 22/05', fontsize=16)
