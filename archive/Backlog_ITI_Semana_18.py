...
file_path = os.path.join(base_dir, 'Backlog_18.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_18_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 11/05 a 15/05', fontsize=16)
