...
file_path = os.path.join(base_dir, 'Backlog_22.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_22_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 08/06 a 12/06', fontsize=16)
