...
file_path = os.path.join(base_dir, 'Backlog_25.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_25_2026.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 29/06 a 03/07', fontsize=16)
