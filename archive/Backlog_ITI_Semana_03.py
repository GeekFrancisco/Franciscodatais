...
file_path = os.path.join(base_dir, 'Backlog_3.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_03_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 26/01 a 30/01', fontsize=16)
