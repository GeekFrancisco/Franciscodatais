...
file_path = os.path.join(base_dir, 'Backlog_8.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_08_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 02/03 a 06/03', fontsize=16)
