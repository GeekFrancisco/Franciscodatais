...
file_path = os.path.join(base_dir, 'Backlog_6.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_ITI_Semana_06_2026.pdf")
...
fig.suptitle('Análise Backlog ITI - Semana 16/02 a 20/02', fontsize=16)
