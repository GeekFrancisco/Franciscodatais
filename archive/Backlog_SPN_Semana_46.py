...
file_path = os.path.join(base_dir, 'Backlog_46.xlsx')
...
pdf_path = os.path.join(diretorio_relatorio, "Graficos_Backlog_SPN_Semana_46_2025.pdf")
...
fig.suptitle('Análise Backlog SPN - Semana 17/11 a 21/11', fontsize=16)
